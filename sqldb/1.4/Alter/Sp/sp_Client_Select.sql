...
-- Description:	<Get all Clients details by Prospect Id except the client having Id=ProspectId>
-- ============================================================================================
ALTER PROCEDURE [dbo].[sp_Client_Select] 
@RowCount int,
@ProspectId int
AS 
BEGIN
...
AND (p.IsActive = 1)AND (p.Id != @ProspectId)
ORDER BY  p.Id DESC   
