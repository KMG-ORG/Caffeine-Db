...
BEGIN    
 ...
 concat(c.FirstName , '',c.LastName) AS ContactName,c.JobTitle as ContactJobTitle,p.CreatedBy,    
  (SELECT COUNT(*) from Disposition where ProspectId = p.Id) as TotalDisposition,    
 ...
 )as prospectList  WHERE prospectList.RowNum = 1  
 order BY prospectList.ModifiedDateTime DESC   
