...
AS      
 ...
 BEGIN
  ...
  END
   ...
   Insert Into CreateList(TypeOfList,SaveAsType,ExpirationDate,IsNewList,ListName,CreateListJSON,CreateListJSONGroup,FilterQuery,CreatedBy,CreatedDateTime,ModifiedBy,ModifiedDateTime,IsDeleted)    
   Values (@TypeOfList,@SaveAsType,@ExpirationDate,@IsNewList,@ListName,@CreateListJSON,@CreateListJSONGroup, @SqlQuery,@CreatedBy,@CreatedDateTime,@CreatedBy,@CreatedDateTime,0)   
